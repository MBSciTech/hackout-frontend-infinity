...
const SolarPanel = () => {
  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      const createElectrolysisUnit = () => {
        ...
        waterPipe.position.set(3, 1.5, 0);
      ...
      const createStorageTanks = () => {
        ...
        for (let i = 0; i < 3; i++) {
          ...
          label.position.set(16.3, 2.5, (i - 1) * 3);
      ...
      const createDistribution = () => {
        ...
        const building = new THREE.Mesh(buildingGeo, materials.concrete);
        building.position.set(25, 1.5, 0);
        building.castShadow = true;
        building.receiveShadow = true;
      ...
      const createHydrogenPipes = () => {
        ...
        const curve2 = new THREE.CatmullRomCurve3([
          ...
          new THREE.Vector3(20, 1.8, 0),
          new THREE.Vector3(23, 1.5, 0)
        ]);
      ...
      particleSystemsRef.current = {
        ...
        gridToElectrolysis: createParticleSystem(
          new THREE.Vector3(-3, 4, 0),
          new THREE.Vector3(5, 3, 0),
          0x00ff00,
          25
        ),
        hydrogenFlow: createParticleSystem(
          new THREE.Vector3(7, 2.5, 0),
          new THREE.Vector3(15, 2.5, 0),
          0x4a90e2,
          40
        ),
        distribution: createParticleSystem(
          new THREE.Vector3(16.5, 2, 0),
          new THREE.Vector3(23, 1.5, 0),
          0x0080ff,
          20
      ...
      const createBubbles = () => {
        ...
        facilitiesRef.current.bubbles = bubbles;
        scene.add(bubbles);
        return bubbles;
      };
    ...
    const animate = () => {
      ...
      if (rendererRef.current && sceneRef.current && cameraRef.current) {
        ...
        // Always animate (removed isRunning condition)
        ...
        // Animate bubbles in electrolysis unit
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden bg-transparent">
      {/* 3D Viewport Only - No UI Elements */}
      <div 
        ref={mountRef} 
